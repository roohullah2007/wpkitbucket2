...
<div class="w-screen relative flex px-4 md:p-8 items-center justify-center flex-col">
  ...
  <div class="flex flex-col items-center w-full space-x-2 text-gray-700">
    <h1 class="text-lg font-semibold">Grant Access</h1>
    <h4 class="block text-sm font-medium text-gray-700 mb-1">Invite another user to access your account. You can always remove them later.</h4>
  </div>
  <div class="flex items-center justify-center p-4">
    <div class="w-full flex items-center justify-center bg-white rounded-lg h-[669px] shadow-lg p-8 space-y-12">
    
        <!-- Form -->
        <form action="#" class="space-y-4">
            <label for="email" class="block text-sm font-semibold text-gray-700 mb-1">Who do you give access to?</label>
          ...
          <div class="space-y-4" id="role-container">
            ...
            >
              ...
              <label for="user" class="cursor-pointer text-sm text-gray-700 w-full">
                ...
                <br />
                <span class="text-gray-500 text-xs">
                    Manage services. Can't make purchases.
                </span>
              </label>
            </div>
          </div>
        ...
        <div class="p-4 w-full bg-gray-100 rounded-lg space-y-8">
            <p for="services" class="text-sm font-medium text-gray-700">Managed services</p>
            <p class="text-sm font-medium text-gray-700">Select services that will be allowed to manage.

            </p>
            <select
              id="services"
              name="services"
              class="border w-[832px] border-gray-300 rounded-lg px-4 py-2 text-gray-700 focus:ring-purple-500 focus:border-purple-500"
              required
            >
